...
/**
 * Used by the server side to write response bytes back to the requesting peer.
 * Supports streaming (multiple write calls) or single-shot transfer.
 */
public class ServiceResponse {

    private static final Logger log = LoggerFactory.getLogger(ServiceResponse.class);
    ...
    ServiceResponse(int requestId, Channel channel) {
